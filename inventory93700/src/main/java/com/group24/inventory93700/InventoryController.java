...
public class InventoryController {
	...
	@GetMapping(value="/inventory/enterInventoryDetails")
	public String insertInventoryDetails() throws SQLException{
		return invRep.enterInventoryDetails(9, "Yes", "Non Fiction");
	}
}
